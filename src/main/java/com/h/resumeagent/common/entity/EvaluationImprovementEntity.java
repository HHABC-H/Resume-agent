...
@AllArgsConstructor
@Entity
@Table(name = "evaluation_improvement", indexes = @Index(name = "idx_eval_improvement_session", columnList = "resume_session_id"))
public class EvaluationImprovementEntity {
